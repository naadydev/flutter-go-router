...
class ProfileScreen extends StatelessWidget {
  ...
  const ProfileScreen({super.key, required this.id1, required this.id2, required this.qParam1, required this.qParam2, required this.employee});

  @override
  Widget build(BuildContext context) {
    // Retrieve Extra data from GoRouterState
    final extraObj = GoRouterState
        .of(context)
        .extra! as Employee;
